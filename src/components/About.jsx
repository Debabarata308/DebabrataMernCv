...
const About = () => {
  const [data, setData] = useState({
    ...
    desc1: `A MERN Developer proficient in React JS combines server-side and client-side development expertise. They leverage NODE JS technologies like EXPRESS JS for backend development and React JS for building dynamic and interactive user interfaces. Their skill set includes database management, API integration, and ensuring seamless communication between front and back ends to deliver robust web applications`,
    actionButton: {
      title: "Read More..",
      link: "/readmore"
    }
